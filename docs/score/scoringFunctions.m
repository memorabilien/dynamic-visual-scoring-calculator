...
g4 = abs(t) + g;
h4(x) = f(exp(99)*x);%ok
v = abs( log(t)-log(g4) )/(3*sqrt(2)*0.9061938024368232);%ok
m4(x) = 1/(1+(0.3275911*abs(x)));%ok
e(x) = sign(x)*(1-(((((1.061405429* m4(x)+-1.453152027)* m4(x))+1.421413741)* m4(x)+-0.284496736)* m4(x)+0.254829592)* m4(x)*exp(-(x*x)));%ok
