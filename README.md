...
* linear
  ...
  <div style="display: flex; justify-content: center; align-items: center; width: 100%"><iframe src="https://www.desmos.com/calculator/5jegji5byd?embed" width="500" height="500" style="border: 1px solid #ccc" frameborder=0></iframe></div>
* quadratic (same concept, different functions)

  <div style="display: flex; justify-content: center; align-items: center; width: 100%"><iframe src="https://www.desmos.com/calculator/argqvy2eea?embed" width="500" height="500" style="border: 1px solid #ccc" frameborder=0></iframe></div>
